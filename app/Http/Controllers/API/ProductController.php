...
class ProductController extends BaseController
{
    ...
    public function index()
    {
        $user = Auth::user();
        $uid = $user->id;
        $items = Product::where('user_id', $uid)->paginate(10);

        // $products = Product::paginate(10);
        // $products = ProductCollection::collection(Product::paginate(2));
 
        return response()->json(new ProductCollection($items), 200);
